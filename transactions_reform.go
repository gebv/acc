...
var TransactionTable = &transactionTableType{
	s: parse.StructInfo{Type: "Transaction", SQLSchema: "finances", SQLName: "transactions", Fields: []parse.FieldInfo{{Name: "TransactionID", Type: "int64", Column: "transaction_id"}, {Name: "InvoiceID", Type: "int64", Column: "invoice_id"}, {Name: "Amount", Type: "int64", Column: "amount"}, {Name: "Source", Type: "int64", Column: "source"}, {Name: "Destination", Type: "int64", Column: "destination"}, {Name: "Status", Type: "TransactionStatus", Column: "status"}, {Name: "CreatedAt", Type: "time.Time", Column: "created_at"}, {Name: "ClosedAt", Type: "time.Time", Column: "closed_at"}}, PKFieldIndex: 0},
...
var BalanceChangesTable = &balanceChangesTableType{
	s: parse.StructInfo{Type: "BalanceChanges", SQLSchema: "finances", SQLName: "balance_changes", Fields: []parse.FieldInfo{{Name: "ChangeID", Type: "int64", Column: "change_id"}, {Name: "AccountID", Type: "int64", Column: "account_id"}, {Name: "TransactionID", Type: "int64", Column: "transaction_id"}, {Name: "Type", Type: "BalanceChangesType", Column: "tx_type"}, {Name: "Amount", Type: "int64", Column: "amount"}, {Name: "Balance", Type: "int64", Column: "balance"}, {Name: "CreatedAt", Type: "time.Time", Column: "created_at"}}, PKFieldIndex: 0},
...
var (
	...
	_ reform.Struct = (*BalanceChanges)(nil)
	_ reform.Table  = BalanceChangesTable
	_ reform.Record = (*BalanceChanges)(nil)
	_ fmt.Stringer  = (*BalanceChanges)(nil)
)
