...
func (v *viewBalanceChangesViewType) Columns() []string {
	return []string{"client_id", "ch_id", "tx_id", "acc_id", "curr_id", "amount", "balance", "balance_accepted", "invoice", "transaction", "operations", "actual_account", "actual_transaction"}
}
...
func (s ViewBalanceChanges) String() string {
	...
	res[1] = "ChID: " + reform.Inspect(s.ChID, true)
	res[2] = "TxID: " + reform.Inspect(s.TxID, true)
	res[3] = "AccID: " + reform.Inspect(s.AccID, true)
	res[4] = "CurrID: " + reform.Inspect(s.CurrID, true)
	res[5] = "Amount: " + reform.Inspect(s.Amount, true)
	res[6] = "Balance: " + reform.Inspect(s.Balance, true)
	res[7] = "BalanceAccepted: " + reform.Inspect(s.BalanceAccepted, true)
	...
	res[11] = "Account: " + reform.Inspect(s.Account, true)
	res[12] = "ActualTransaction: " + reform.Inspect(s.ActualTransaction, true)
