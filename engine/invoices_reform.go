...
func (v *invoiceTableType) Columns() []string {
	return []string{"invoice_id", "key", "status", "total_amount", "strategy", "meta", "payload", "updated_at", "created_at"}
}
...
var InvoiceTable = &invoiceTableType{
	s: parse.StructInfo{Type: "Invoice", SQLSchema: "acca", SQLName: "invoices", Fields: []parse.FieldInfo{{Name: "InvoiceID", Type: "int64", Column: "invoice_id"}, {Name: "Key", Type: "string", Column: "key"}, {Name: "Status", Type: "InvoiceStatus", Column: "status"}, {Name: "TotalAmount", Type: "int64", Column: "total_amount"}, {Name: "Strategy", Type: "string", Column: "strategy"}, {Name: "Meta", Type: "*[]uint8", Column: "meta"}, {Name: "Payload", Type: "*[]uint8", Column: "payload"}, {Name: "UpdatedAt", Type: "time.Time", Column: "updated_at"}, {Name: "CreatedAt", Type: "time.Time", Column: "created_at"}}, PKFieldIndex: 0},
...
func (s Invoice) String() string {
	...
	res[3] = "TotalAmount: " + reform.Inspect(s.TotalAmount, true)
