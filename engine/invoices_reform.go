...
func (v *invoiceTableType) Columns() []string {
	return []string{"invoice_id", "client_id", "key", "status", "next_status", "strategy", "meta", "payload", "updated_at", "created_at"}
}
