...
func (v *transactionTableType) Columns() []string {
	return []string{"tx_id", "invoice_id", "key", "strategy", "provider", "provider_oper_id", "provider_oper_status", "meta", "status", "next_status", "updated_at", "created_at"}
}
...
func (s Transaction) String() string {
	...
	res[4] = "Provider: " + reform.Inspect(s.Provider, true)
	res[5] = "ProviderOperID: " + reform.Inspect(s.ProviderOperID, true)
	res[6] = "ProviderOperStatus: " + reform.Inspect(s.ProviderOperStatus, true)
	res[7] = "Meta: " + reform.Inspect(s.Meta, true)
	res[8] = "Status: " + reform.Inspect(s.Status, true)
	res[9] = "NextStatus: " + reform.Inspect(s.NextStatus, true)
