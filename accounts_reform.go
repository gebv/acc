...
var AccountTable = &accountTableType{
	s: parse.StructInfo{Type: "Account", SQLSchema: "finances", SQLName: "accounts", Fields: []parse.FieldInfo{{Name: "AccountID", Type: "int64", Column: "account_id"}, {Name: "CustomerID", Type: "string", Column: "customer_id"}, {Name: "Type", Type: "AccountType", Column: "account_type"}, {Name: "Balance", Type: "int64", Column: "balance"}, {Name: "UpdatedAt", Type: "time.Time", Column: "updated_at"}}, PKFieldIndex: 0},
